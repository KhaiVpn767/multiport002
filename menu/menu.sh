...
echo -e "${BIYellow}□ AutoScript By Dev   = Wak ${GREEN}( KhaiVpn767 )${NC}"

echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │         ${BIWhite}${UWhite}KhaiVpn767 TUNNELING${NC}     ${BICyan}│${NC}"
echo -e "${BICyan} │                                                     │${NC}"
...
13) clear ; slow ;;
99) clear ; clearcache ;;
6969) clear ; wget https://raw.githubusercontent.com/KhaiVpn767/multiport002/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
